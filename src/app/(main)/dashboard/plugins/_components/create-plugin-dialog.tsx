...
export function CreatePluginDialog({ open, onOpenChange, onSave }: CreatePluginDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex h-[90vh] w-[95vw] max-w-full flex-col gap-0 overflow-hidden p-0 sm:rounded-xl">
        <DialogHeader className="sr-only">
          <DialogTitle>Create Plugin</DialogTitle>
          <DialogDescription>Create and debug a new plugin.</DialogDescription>
        </DialogHeader>
